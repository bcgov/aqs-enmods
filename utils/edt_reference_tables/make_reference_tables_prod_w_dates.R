...
AMs_final <- AMs %>% select('Method ID' = methodId,
                      'Method Name' = name...4,
...
put_object(file = "./utils/edt_reference_tables/tables/All_Observed_Properties.csv", 
           object = paste0("Reference_Lists/All_Observed_Properties", today_date, ".csv"),
           bucket = "enmods",
           region = "",
           acl = "public-read")

put_object(file = "./utils/edt_reference_tables/tables/Taxonomic_Observed_Properties-2026.csv", 
           object = paste0("Reference_Lists/Taxonomic_Observed_Properties", today_date, ".csv"),
           bucket = "enmods",
           region = "",
           acl = "public-read")

put_object(file = "./utils/edt_reference_tables/tables/Analytical_Methods.csv", 
           object = paste0("Reference_Lists/Analytical_Methods", today_date, ".csv"),
           bucket = "enmods",
           region = "",
           acl = "public-read")

put_object(file = "./utils/edt_reference_tables/tables/Observed_Properties_and_Analytical_Methods.csv", 
           object = paste0("Reference_Lists/Observed_Properties_and_Analytical_Methods", today_date, ".csv"),
           bucket = "enmods",
           region = "",
           acl = "public-read")

put_object(file = "./utils/edt_reference_tables/tables/Units.csv", 
           object = paste0("Reference_Lists/Units", today_date, ".csv"),
           bucket = "enmods",
           region = "",
           acl = "public-read")

put_object(file = "./utils/edt_reference_tables/tables/Mediums.csv", 
           object = paste0("Reference_Lists/Mediums", today_date, ".csv"),
           bucket = "enmods",
           region = "",
           acl = "public-read")

put_object(file = "./utils/edt_reference_tables/tables/Collection_Methods.csv", 
           object = paste0("Reference_Lists/Collection_Methods", today_date, ".csv"),
           bucket = "enmods",
           region = "",
           acl = "public-read")

put_object(file = "./utils/edt_reference_tables/tables/Sampling_Agencies.csv", 
           object = paste0("Reference_Lists/Sampling_Agencies", today_date, ".csv"),
           bucket = "enmods",
           region = "",
           acl = "public-read")

put_object(file = "./utils/edt_reference_tables/tables/Labs.csv", 
           object = paste0("Reference_Lists/Labs", today_date, ".csv"),
           bucket = "enmods",
           region = "",
           acl = "public-read")

put_object(file = "./utils/edt_reference_tables/tables/Detection_Conditions.csv", 
           object = paste0("Reference_Lists/Detection_Conditions", today_date, ".csv"),
           bucket = "enmods",
           region = "",
           acl = "public-read")

put_object(file = "./utils/edt_reference_tables/tables/Tissue_Types.csv", 
           object = paste0("Reference_Lists/Tissue_Types", today_date, ".csv"),
           bucket = "enmods",
           region = "",
           acl = "public-read")

put_object(file = "./utils/edt_reference_tables/tables/Biological_Life_Stage.csv", 
           object = paste0("Reference_Lists/Biological_Life_Stage", today_date, ".csv"),
           bucket = "enmods",
           region = "",
           acl = "public-read")
...
put_object(file = "./utils/edt_reference_tables/tables/Fish_Taxons.csv", 
           object = paste0("Reference_Lists/Fish_Taxons", today_date, ".csv"),
           bucket = "enmods",
           region = "",
           acl = "public-read")

put_object(file = "./utils/edt_reference_tables/tables/Projects.csv", 
           object = paste0("Reference_Lists/Projects", today_date, ".csv"),
           bucket = "enmods",
           region = "",
           acl = "public-read")

put_object(file = "./utils/edt_reference_tables/tables/Projects_w_contacts.csv", 
           object = paste0("Reference_Lists/Projects_w_contacts", today_date, ".csv"),
           bucket = "enmods",
           region = "",
           acl = "public-read")
